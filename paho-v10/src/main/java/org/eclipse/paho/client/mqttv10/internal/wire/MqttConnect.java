...
public class MqttConnect extends MqttWireMessage
{
	...
	private List<org.eclipse.paho.client.mqttv10.internal.wire.UserProperty> userProperties;
	...
	{
		super(org.eclipse.paho.client.mqttv10.internal.wire.MqttWireMessage.MESSAGE_TYPE_CONNECT);
	...
	public MqttConnect(
			...
			String protocolName,
			int protocolLevel,
			List<org.eclipse.paho.client.mqttv10.internal.wire.UserProperty> userProperties
	) {
		super(org.eclipse.paho.client.mqttv10.internal.wire.MqttWireMessage.MESSAGE_TYPE_CONNECT);
	...
	public byte[] getPayload() throws MqttException
	{
		try
		{
			...
			if (userProperties != null && !userProperties.isEmpty()) {
				for (org.eclipse.paho.client.mqttv10.internal.wire.UserProperty property : userProperties) {
