		...
		if (INSTANCE == null)
		{
			if (ExceptionHelper.isClassAvailable("java.util.ResourceBundle"))
			{
				try
				{
					...
					INSTANCE = (MessageCatalog) Class.forName("org.eclipse.paho.client.mqttv10.internal.ResourceBundleCatalog").newInstance();
				}
				catch (Exception e)
				{
					return "";
			...
			else if (ExceptionHelper.isClassAvailable("org.eclipse.paho.client.mqttv10.internal.MIDPCatalog"))
			{
				try
				{
					INSTANCE = (MessageCatalog) Class.forName("org.eclipse.paho.client.mqttv10.internal.MIDPCatalog").newInstance();
				}
				catch (Exception e)
				{
					return "";
