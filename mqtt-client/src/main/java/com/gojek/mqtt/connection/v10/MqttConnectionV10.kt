package com.gojek.mqtt.connection.v10
...
import com.gojek.mqtt.exception.handler.MqttExceptionHandler
import com.gojek.mqtt.exception.handler.impl.MqttExceptionHandlerImpl
...
import org.eclipse.paho.client.mqttv10.DisconnectedBufferOptions
...
import org.eclipse.paho.client.mqttv10.IMqttDeliveryToken
import org.eclipse.paho.client.mqttv10.IMqttToken
import org.eclipse.paho.client.mqttv10.MqttAsyncClient
import org.eclipse.paho.client.mqttv10.MqttCallback
import org.eclipse.paho.client.mqttv10.MqttConnectOptions
...
import org.eclipse.paho.client.mqttv10.internal.wire.UserProperty
import com.gojek.mqtt.persistence.impl.v10.PahoPersistence
import com.gojek.mqtt.logging.v10.PahoLogger

import org.eclipse.paho.client.mqtt.MqttException
import org.eclipse.paho.client.mqtt.MqttException.REASON_CODE_INVALID_SUBSCRIPTION
import org.eclipse.paho.client.mqtt.MqttException.REASON_CODE_UNEXPECTED_ERROR


internal class MqttConnectionV10(
        ...
        if (topicMap.isNotEmpty()) {
            ...
            try {
                ...
                mqtt!!.subscribe(
                    topicArray,
                    qosArray,
                    MqttContextV10(subscribeStartTime),
    ...
    override fun unsubscribe(topics: Set<String>) {
        if (topics.isNotEmpty()) {
            ...
            try {
                ...
                mqtt!!.unsubscribe(
                    topics.toTypedArray(),
                    MqttContextV10(unsubscribeStartTime),
    ...
    private fun getSubscribeListener(topicMap: Map<String, QoS>): IMqttActionListener {
        return object : IMqttActionListener {
            override fun onSuccess(iMqttToken: IMqttToken) {
                ...
                val context = iMqttToken.userContext as MqttContextV10
...
private data class MqttContextV10(val startTime: Long)
