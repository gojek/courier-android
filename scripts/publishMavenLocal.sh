...
./gradlew :paho:assemble -PIS_CI=:$1 :paho-v5:assemble -PIS_CI=:$1 :courier-core:assemble -PIS_CI=:$1 :courier-core-android:assemble -PIS_CI=:$1 --parallel --daemon && ./gradlew :paho:publishToMavenLocal -PIS_CI=:$1 :paho-v5:publishToMavenLocal -PIS_CI=:$1 :courier-core:publishToMavenLocal -PIS_CI=:$1 :courier-core-android:publishToMavenLocal -PIS_CI=:$1 --parallel --daemon
