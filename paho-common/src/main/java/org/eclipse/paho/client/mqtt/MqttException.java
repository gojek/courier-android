...
public class MqttException extends Exception
{
	...
	/**
	 * The client is not connected to the server. The MqttClient#connect() or MqttClient#connect(MqttConnectOptions) method must be called first. It is also
	 * possible that the connection was lost - see MqttClient#setCallback(MqttCallback) for a way to track lost connections.
	 */
	...
	/**
	 * Thrown when an attempt to call MqttClient#disconnect() has been made from within a method on MqttCallback. These methods are invoked by the client's thread,
