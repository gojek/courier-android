...
public class ClientComms {
	...
	public ClientComms(MqttClientInterface client, MqttClientPersistence persistence, MqttPingSender pingSender,
		...
		this(client, persistence, pingSender, executorService, mqttSession, mqttConnection,
	 ...
	 */
	public ClientComms(MqttClientInterface client, MqttClientPersistence persistence, MqttPingSender pingSender,
			ExecutorService executorService, MqttSessionState mqttSession, MqttConnectionState mqttConnection,
			int maxInflightMsgs, ILogger logger, IExperimentsConfig experimentsConfig,
			List<MqttInterceptor> mqttInterceptorList, IPahoEvents pahoEvents) throws MqttException {
		...
		this.clientState = new ClientState(persistence, tokenStore, this.callback, this, pingSender,
				this.mqttConnection, maxInflightMsgs, this.logger, experimentsConfig, this.pahoEvents);
		this.mqttInterceptorCallback = new MqttInterceptorCallback(mqttInterceptorList, this.logger);
