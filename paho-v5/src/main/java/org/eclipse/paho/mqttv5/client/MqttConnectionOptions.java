...
public class MqttConnectionOptions {
	...
	private SSLSocketFactory sslSocketFactory; // SSLSocketFactory for the new SSL flow
	private X509TrustManager x509TrustManager; // X509TrustManager for the new SSL flow
	private ConnectionSpec connectionSpec; // okhttp-style connection spec for the new SSL flow
	private List<Protocol> alpnProtocolList; // ALPN protocols for the new SSL flow
	private int handshakeTimeout = HANDSHAKE_TIMEOUT_DEFAULT; // SSL handshake timeout in seconds
	private int readTimeout = READ_TIMEOUT_DEFAULT; // Socket read timeout in seconds
	...
	/**
	 * Validate a URI and return its type.
	 *
	 * @param srvURI The Server URI
	 * @return the URI type (one of the URI_TYPE_* constants)
	 */
